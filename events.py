...
class Worker_events(Agent):
    ...
    def step(self):
        ...
        self.training()
        self.motivational_event()
        self.seek_job()

class JobOffer_events(Agent):
...
class LabourMarket_events(Model):
    def __init__(self, N, width, height, M=0.4):
        ...
        for i in range(self.num_agents):
            ...
            a = Worker_events(i, self, level, age, education,total_tenure)
            self.schedule.add(a)
    ...
    def add_agents(self):
        ...
        if new_entry > 0:        
            for i in range(new_entry):
                ...
                a = Worker_events(self.total_agents_count, self)
                self.schedule.add(a)
